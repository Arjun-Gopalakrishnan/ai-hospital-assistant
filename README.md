...
bash
git clone https://github.com/Arjun-Gopalakrishnan/ai-hospital-assistant.git
...
### 3. Frontend Setup
Open `index.html` directly in any web browser, or serve it locally from the project root:
bash
